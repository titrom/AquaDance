...
def move_func(start, t):
    x_1, v_x1, y_1, v_y1, x_2, v_x2, y_2, v_y2, x_3, v_x3, y_3, v_y3\
        , x_4, v_x4, y_4, v_y4, x_5, v_x5, y_5, v_y5 = start
    ...
    return dx1_dt, dvx1_dt, dy1_dt, dvy1_dt, dx2_dt, dvx2_dt, dy2_dt, dvy2_dt, dx3_dt, dvx3_dt, dy3_dt, dvy3_dt\
        , dx4_dt, dvx4_dt, dy4_dt, dvy4_dt, dx5_dt, dvx5_dt, dy5_dt, dvy5_dt
...
radius = 0.6
balls = []
ball1 = Ball.Ball(1.1, 0, 3, 0, 1)
ball2 = Ball.Ball(-1.1, 0, 3, 0, 1)
ball3 = Ball.Ball(0, 0, -3, 5, 1)
ball4 = Ball.Ball(-3, 4,-1 , 0, 1)
ball5 = Ball.Ball(3, -4,-1 , 0, 1)
